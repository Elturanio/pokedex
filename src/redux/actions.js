...
import { CHANGE_INPUT_VALUE, CHANGE_LIMIT, FETCH_POKEMONS, LOADING_ON, MAX_OFFSET, MINUS_OFFSET, MIN_OFFSET, PLUS_OFFSET, LOADING_OFF, SEARCH_POKEMON, IS_ERROR, IS_NOT_ERROR } from "./types"
...
export const handleSubmitFromActions = (name) => {
